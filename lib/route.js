...
Route.prototype = {
  ...
  /**
   * get an option stored in "data" by keyname or return default value.
   * No need to check if exists
   *
   * @param {String} name of the key to get
   * @param {Object} default value to return if key not exists (optional)
   * @return {Object}
   */
  getFromData: function (keyname, defaultValue) {
  if (this.options.data !== void 0 && this.options.data[keyname] !== void 0) {
