if (Handlebars) {
  ...
  Handlebars.registerHelper('highlightIfActive', function (routeName, options) {
    var activeName = options.hash.activeName;
    var inactiveName = options.hash.inactiveName;
    return Router.highlightIfActive(routeName, activeName, inactiveName);
  });
}
